...
CREATE TABLE `pms_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_comment
-- ----------------------------
INSERT INTO `pms_comment` VALUES (1, 1, '昵称test2', '产品名称2', 5, '123', '2022-09-14 10:25:02', 1, '购买时商品属性', 1, 10, 'asddasasdads', NULL, NULL, 12);
INSERT INTO `pms_comment` VALUES (2, 1, '昵称test31', '产品名称31', 5, '123', '2022-09-14 10:25:02', 1, '购买时商品属性', 1, 10, 'asddasasdads', NULL, NULL, 12);
INSERT INTO `pms_comment` VALUES (3, 1, '昵称test11', '产品名称11', 5, '123', '2022-09-14 10:25:02', 1, '购买时商品属性', 1, 10, 'asddasasdads', NULL, NULL, 12);
