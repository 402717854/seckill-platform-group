 ...
 */
package com.seckill.platform.system.modules.quartz.service.impl;
...
import com.seckill.platform.system.modules.quartz.domain.QuartzJob;
import com.seckill.platform.system.modules.quartz.domain.QuartzLog;
import com.seckill.platform.system.modules.quartz.repository.QuartzJobRepository;
import com.seckill.platform.system.modules.quartz.repository.QuartzLogRepository;
import com.seckill.platform.system.modules.quartz.service.QuartzJobService;
import com.seckill.platform.system.modules.quartz.service.dto.JobQueryCriteria;
import com.seckill.platform.system.modules.quartz.utils.QuartzManage;
...
public class QuartzJobServiceImpl implements QuartzJobService {
    ...
    public void executionSubJob(String[] tasks) throws InterruptedException {
        for (String id : tasks) {
            ...
            RBucket<Object> rBucket = RedissonUtils.getRBucket(uuid);
            Boolean result = (Boolean) rBucket.get();
            while (result == null) {
                // 休眠5秒，再次获取子任务执行情况
                Thread.sleep(5000);
                result = (Boolean) rBucket.get();
            }
            if(!result){
                rBucket.delete();
                break;
