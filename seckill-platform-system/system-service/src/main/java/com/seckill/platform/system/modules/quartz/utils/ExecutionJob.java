 ...
 */
package com.seckill.platform.system.modules.quartz.utils;
...
import com.seckill.platform.system.config.thread.ThreadPoolExecutorUtil;
...
import com.seckill.platform.system.tools.service.EmailService;
    ...
    public void executeInternal(JobExecutionContext context) {
        ...
        try {
            ...
            if(StringUtils.isNotBlank(uuid)) {
                RedissonUtils.getRBucket(uuid).set(true);
            }
            // 任务状态
            ...
            if(StringUtils.isNotBlank(uuid)) {
                RedissonUtils.getRBucket(uuid).set(false);
            }
